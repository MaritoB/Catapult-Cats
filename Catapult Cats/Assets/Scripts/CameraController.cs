...
public class CameraController : MonoBehaviour
{
  [SerializeField] private Transform playerTransform; // Objeto que seguirá la cámara
    ...
    [SerializeField] private float smoothSpeed = 0.125f; // Velocidad de la cámara
    [SerializeField] private float offset = 3f; // Distancia de la cámara respecto al objeto que sigue
    [SerializeField] private float minCameraX = -100f; // Límite mínimo de la cámara en el eje X
    [SerializeField] private float maxCameraX = 100f; // Límite máximo de la cámara en el eje X
    [SerializeField] private float minCameraY = -10f; // Altura mínima de la cámara
    [SerializeField] private float maxCameraY = 100f; // Altura máxima de la cámara
